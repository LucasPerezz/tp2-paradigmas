...
public class RecitalTest {
    ...
    public void contratarPorCancionTest() {
        // Crear un recital nuevo para evitar estado compartido con otros tests
        final Recital nuevoRecital = new Recital(new ArrayList<>(artistas), List.of(cancion));
    ...
    public void contratacionesMasivasTest() {
        ...
        final ArtistaCandidato pedro1 = new ArtistaCandidato("Pedro1", List.of(new Banda("GUNS")), new ArrayList<>(List.of(Rol.BAJISTA, Rol.PIANISTA)), 10.0, 3);
        final ArtistaCandidato pedro2 = new ArtistaCandidato("Pedro2", List.of(new Banda("GUNS")), new ArrayList<>(List.of(Rol.GUITARRISTA)), 10.0, 3);
        final ArtistaCandidato pedro3 = new ArtistaCandidato("Pedro3", List.of(new Banda("SODA")), new ArrayList<>(List.of(Rol.GUITARRISTA)), 10.0, 3);
        final ArtistaCandidato pedro4 = new ArtistaCandidato("Pedro4", List.of(new Banda("SODA")), new ArrayList<>(List.of(Rol.BATERISTA)), 6.0, 3);
        final ArtistaCandidato pedro5 = new ArtistaCandidato("Pedro5", List.of(new Banda("GUNS")), new ArrayList<>(List.of(Rol.BATERISTA)), 6.0, 2);
        final ArtistaCandidato pedro6 = new ArtistaCandidato("Pedro6", List.of(new Banda("SODA")), new ArrayList<>(List.of(Rol.VOCALISTA)), 6.0, 2);
    ...
    public void listadoDeContratados() {
        final ArtistaCandidato pedro1 = new ArtistaCandidato("Pedro1", List.of(), new ArrayList<>(List.of(Rol.BAJISTA)), 10.0, 3);
